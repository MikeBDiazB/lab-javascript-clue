...
const roomsArray = [
  diningRoom, conservatory, kitchen, study, library, billiardRoom, lounge, ballroom, hall, 
  spa, livingRoom, observatory, theater, guestHouse, patio
];

//Step 1: Create the selectRandom function

function selectRandom(array) {
  return array[Math.floor(Math.random() * array.length)];
}

// Step 2: Create the pickMystery function
...
// Create the revealMystery function
